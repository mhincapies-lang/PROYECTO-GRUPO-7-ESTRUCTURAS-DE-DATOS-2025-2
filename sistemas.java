...
class MatterGraph {
    ...
    private void initializeMatters() {
        ...
        matters.put(2015155, new Matter(2015155, "Análisis Real"));
        ...
        matters.put(2015184, new Matter(2015184, "Lógica Matemática"));
        ...
        matters.put(2016342, new Matter(2016342, "Cálculo de ecuaciones diferenciales ordinarias", 
            Arrays.asList(Arrays.asList(1000005), Arrays.asList(2015556), Arrays.asList(1000003), Arrays.asList(2015555))));
        matters.put(2016353, new Matter(2016353, "Bases de Datos", 
            Arrays.asList(Arrays.asList(2016375))));
        matters.put(2016360, new Matter(2016360, "Diseño de Experimentos"));
        ...
        matters.put(2016379, new Matter(2016379, "Inferencia Estadística", 
            Arrays.asList(Arrays.asList(1000013), Arrays.asList(2015178))));
        matters.put(2016487, new Matter(2016487, "Campos Electromagnéticos", 
            Arrays.asList(Arrays.asList(1000006), Arrays.asList(2015162), Arrays.asList(1000017), Arrays.asList(2016506))));
        matters.put(2016489, new Matter(2016489, "Circuitos Eléctricos I", 
            Arrays.asList(Arrays.asList(2016509), Arrays.asList(1000004), Arrays.asList(2016377))));
        ...
        matters.put(2016506, new Matter(2016506, "Señales y Sistemas I", 
            Arrays.asList(Arrays.asList(2016489), Arrays.asList(2016342))));
        ...
        matters.put(2016512, new Matter(2016512, "Verifivación de Sistemas Digitales", 
            Arrays.asList(Arrays.asList(2016499))));
        matters.put(2016592, new Matter(2016592, "Econimía general"));
        ...
        matters.put(2019082, new Matter(2019082, "Modelos matemáticos I", 
            Arrays.asList(Arrays.asList(1000006, 2015162), Arrays.asList(2025964, 2026519), Arrays.asList(1000013, 2015178), Arrays.asList(2016375))));
        ...
        matters.put(2025986, new Matter(2025986, "Ingeniería Económica y Análisis de Riesgo", 
            Arrays.asList(Arrays.asList(1000005, 2015556), Arrays.asList(1000013), Arrays.asList(2027877, 2015178), Arrays.asList(2016610))));
        ...
        matters.put(2026519, new Matter(2026519, "Ecuaciones en Diferencias Finitas y Sistemas Dinámicos", 
            Arrays.asList(Arrays.asList(1000003), Arrays.asList(2015555), Arrays.asList(2015181))));
